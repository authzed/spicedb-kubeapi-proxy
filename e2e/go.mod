...
require (
	...
	go.temporal.io/api v1.23.1-0.20230809151511-056e78321730 // indirect
...
replace (
	// statsd dependency conflict, this pins to the versions in temporal
	github.com/cactus/go-statsd-client/statsd => github.com/cactus/go-statsd-client/statsd v0.0.0-20200423205355-cb0885a1018c
	github.com/cactus/go-statsd-client/v5 => github.com/cactus/go-statsd-client/v5 v5.0.0

	// https://github.com/temporalio/temporal/pull/4772
	go.temporal.io/server => github.com/DataDog/temporal v0.0.0-20230814125927-660a8386f207

	// reflection api changes that spicedb needs to be updated for
