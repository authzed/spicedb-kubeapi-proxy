...
require (
	github.com/authzed/authzed-go v1.3.1-0.20250331134421-ab067d30d14f
	github.com/authzed/spicedb v1.42.0
...
require (
	...
	github.com/cschleiden/go-workflows v0.19.0 // indirect
